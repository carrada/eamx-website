...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[600px] md:h-[700px] flex-col items-center justify-center overflow-hidden bg-black w-full rounded-md z-0",
        className
      )}
    >
      ...
      <div className="relative z-50 flex -translate-y-[15rem] md:-translate-y-[16rem] lg:-translate-y-[18rem] flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
